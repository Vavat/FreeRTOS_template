...
public:
   ...
   */
  bool SetupHalfDuplexControl(GPIO_TypeDef *pTxEnablePort,
   ...
   * 			when interrupt fires this function is called to store
   * received character in the buffer for processing at allocated time slot.
   */
  void RxChar();
   ...
   * 			This is a way of letting Comms controller know where to
   * send commands it receives.
...
private:
  ...
  /* Variable to be fed as a temp storage to interrupt driven Receive function
   * of HAL */
